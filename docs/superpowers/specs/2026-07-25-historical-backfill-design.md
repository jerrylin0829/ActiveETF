...
| 狀態 | 檔數 | 投信 |
|---|---|---|
| ✅ 確認支援，可回溯至上市初期 | **9** | 統一（00981A、00403A、00988A）、元大（00990A）、國泰（00400A）、第一金（00994A）、安聯（00402A、00984A、00993A） |
| ⚠️ 待確認 | 6 | 中信（探測腳本請求有誤，非確認不支援）、野村（WAF 阻擋中） |
...
- 預估：9 檔 × 各自上市至今交易日 ≈ 2,000–2,500 次請求、約 1.5 小時
