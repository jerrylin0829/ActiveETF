...
@responses.activate
def test_total_return_index_returns_rows(monkeypatch):
    monkeypatch.setenv("FINMIND_TOKEN", "t")
    _mock([{"date": "2026-07-03", "price": 50000.0}])
    rows = finmind.total_return_index("2026-07-03", "2026-07-03")
...
def test_error_status_raises(monkeypatch):
    ...
    try:
        finmind.total_return_index("2026-07-03", "2026-07-03")
        assert False
